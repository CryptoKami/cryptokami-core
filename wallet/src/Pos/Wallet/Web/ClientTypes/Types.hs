...
-- Includes data which is not provided by Cryptokami
...
-- | Client profile (CP)
-- all data of client are "meta data" - that is not provided by Cryptokami
-- (Flow type: accountType)
-- TODO: Newtype?
...
-- It includes meta data which are not part of Cryptokami, too
