...
[Proofs of transaction legitimacy]: https://cryptokamidocs.com/cryptokami/transactions/#proofs-of-transaction-legitimacy
...
[Plutus]: https://cryptokamidocs.com/technical/plutus/introduction/
...
Since everywhere else in Cryptokami we use `PublicKey` and `SecretKey`, we need
