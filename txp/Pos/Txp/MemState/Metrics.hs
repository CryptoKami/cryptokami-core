...
import           Pos.System.Metrics.Constants (withCryptokamiNamespace)
...
recordTxpMetrics ekgStore memPoolVar = do
    ekgMemPoolSize        <- Metrics.createGauge (withCryptokamiNamespace "MemPoolSize") ekgStore
    ekgMemPoolWaitTime    <- Metrics.createGauge (withCryptokamiNamespace "MemPoolWaitTime_microseconds") ekgStore
    ekgMemPoolModifyTime  <- Metrics.createGauge (withCryptokamiNamespace "MemPoolModifyTime_microseconds") ekgStore
    ekgMemPoolQueueLength <- Metrics.createGauge (withCryptokamiNamespace "MemPoolQueueLength") ekgStore
