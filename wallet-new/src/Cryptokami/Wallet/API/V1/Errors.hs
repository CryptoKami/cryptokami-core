...
module Cryptokami.Wallet.API.V1.Errors where

import           Universum

import           Cryptokami.Wallet.API.Response.JSend (ResponseStatus (ErrorStatus))
import           Data.Aeson
...
import           Cryptokami.Wallet.API.V1.Generic (gconsNames, gparseJsend, gtoJsend)
...
--
-- TODO: change fields' types to actual Cryptokami core types, like `Coin` and `Address`
data WalletError =
