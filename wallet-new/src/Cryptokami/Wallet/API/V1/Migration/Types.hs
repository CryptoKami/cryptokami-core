...
module Cryptokami.Wallet.API.V1.Migration.Types (
      Migrate(..)
    , migrate
    ) where
...
import           Cryptokami.Wallet.API.V1.Errors as Errors
import qualified Cryptokami.Wallet.API.V1.Types as V1
...
-- coded here: https://github.com/CryptoKami/daedalus/blob/master/app/stores/NetworkStatusStore.js#L108
