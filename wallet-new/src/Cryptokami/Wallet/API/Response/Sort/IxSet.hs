module Cryptokami.Wallet.API.Response.Sort.IxSet where

import           Universum hiding (toList)

import           Cryptokami.Wallet.API.Indices (Indexable', IsIndexOf', IxSet')
import qualified Cryptokami.Wallet.API.Request.Sort as S
