...
module Cryptokami.Wallet.API.Response.Filter.Legacy (
    applyFilters
    ) where

import           Universum

import           Cryptokami.Wallet.API.Indices (Indexable', IsIndexOf', ToIndex (..))
import qualified Cryptokami.Wallet.API.Request.Filter as F
