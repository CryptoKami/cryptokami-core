...
This is the specification for the Cryptokami Wallet API, automatically generated
as a [Swagger](https://swagger.io/) spec from the [Servant](http://haskell-servant.readthedocs.io/en/stable/) API
of [Cryptokami](https://github.com/CryptoKami/cryptokami-sl).
...
api = toSwagger walletAPI
  & info.title   .~ "Cryptokami Wallet API"
  & info.version .~ "2.0"
  & host ?~ "127.0.0.1:8090"
