...
-   An edgenode monitors the state of the blockchain, and when an update
    ...
    [ucDownloadedUpdate](https://github.com/input-output-hk/cryptokami-sl/blob/master/update/Pos/Update/Download.hs#L130) variable.
...
the (**current**) update system:
    ...
    info:
      version: 1.0.2
      title: V0 Update API
      description: This is a subset of the API for Cryptokami SL wallet.
    host: 'localhost:8090'
    paths:
      /api/update:
        get:
