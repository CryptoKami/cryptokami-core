...
-- version of wallet web API description at cryptokamidocs.com website
...
import qualified Paths_cryptokami_sl_explorer as CSLE
    ...
    showProgramInfoIfRequired generatedJSON = void $ execParser programInfo
      where
        ...
        versionOption = infoOption
            ("cryptokami-swagger-" <> showVersion CSLE.version)
