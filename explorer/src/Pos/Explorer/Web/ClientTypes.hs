...
-- See this page for more explanation - https://cryptokamidocs.com/cryptokami/addresses/
...
-- | Client address. The address may be from either Cryptokami or RSCoin.
...
data CGenesisAddressInfo = CGenesisAddressInfo
    { cgaiCryptokamiAddress :: !CAddress
    -- Commenting out RSCoin address since currently genesisUtxo stores
    -- only Cryptokami addresses, which are essentially hashes of RSCoin addresses
