...
type Footer =
    ...
    , fooWhyCryptokami :: String
    , fooCryptokamiRoadmap :: String
    , fooCryptokamiSource :: String
    , fooCryptokamiDocumentation :: String
    , fooCryptokamiFoundation :: String
    , fooCryptokamiFoundationYoutube :: String
    , fooCryptokamiFoundationTwitter :: String
    , fooCryptokamiHub :: String
    , fooCryptokamiSlack :: String
    , fooCryptokamiReddit :: String
    , fooCryptokamiCommunity :: String
    , fooCryptokamiTestnet :: String
    , fooCryptokamiOpenSource :: String
    , fooIOHK :: String
    , fooIOHKBlog :: String
