...
translation =
    ...
    , footer:
        ...
        , fooWhyCryptokami: "なぜカルダノなのか"
        , fooCryptokamiRoadmap: "カルダノロードマップ"
        , fooCryptokamiSource: "カルダノSLソース"
        , fooCryptokamiFoundation: "カルダノ財団"
        , fooCryptokamiFoundationYoutube: "カルダノ財団 Youtube"
        , fooCryptokamiFoundationTwitter: "カルダノ財団 Twitter"
        , fooCryptokamiHub: "カルダノハブ"
        , fooCryptokamiSlack: "カルダノ財団 Slack"
        , fooCryptokamiReddit: "カルダノ財団 Reddit"
        , fooCryptokamiCommunity: "カルダノコミュニティー"
        , fooCryptokamiDocumentation: "カルダノドキュメンテーション"
        , fooCryptokamiTestnet: "カルダノテストネット"
        , fooCryptokamiOpenSource: "カルダノはオープンソースプロジェクトです"
        , fooIOHK: "IOHK"
        , fooIOHKBlog: "IOHKブログ"
