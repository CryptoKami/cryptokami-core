...
# This helper script facilitates work with cryptokami-auxx.
...
# If COMMAND is not passed, 'args' are passed directly to cryptokami-auxx.
...
binary=$(find_binary cryptokami-auxx)
