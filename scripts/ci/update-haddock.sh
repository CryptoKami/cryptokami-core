...
echo "**** 3. Cloning cryptokamidocs.com repository ****"
# Variable ${GITHUB_CARDANO_DOCS_ACCESS} already stored in Travis CI settings for 'cryptokami-sl' repository.
...
if [ "${CURRENT_BRANCH}" = "${PROJECT_FULL_NAME}" ]; then
    ...
    # 2. Add href in Haddock-page (cryptokamidocs.com/for-contributors/haddock).
