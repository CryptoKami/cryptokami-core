...
stack exec --nix -- cryptokami-keygen --configuration-file node/configuration.yaml --configuration-key mainnet_launch_base generate-avvm-seeds -n "$AVVM_SEED_COUNT" -o "$AVVM_SECRET"
